...
public:
    struct Wrapper final : RefWrapper<ServerPipe, ServerPipeMock>
    {
        ...
        sdk::OptError send(const ClientId client_id, const ListOfPayloads& payloads) override
        {
    ...
    MOCK_METHOD(sdk::OptError, send, (const ClientId client_id, const ListOfPayloads& payloads), (override));
